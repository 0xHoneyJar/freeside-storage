...
> The freeside-* attachment module for **file storage layout + static-asset CDN + NFT metadata serving + retrieval API**. The canonical abstraction across NFT metadata, music, archetype images, future blob types. Closes [`loa-freeside#167`](https://github.com/0xHoneyJar/loa-freeside/issues/167).
